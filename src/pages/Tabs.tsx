...
const Tabs = () => {
  ...
  const tabColorMode = (focus: any): string => {
    if (!isDarkMode) {
      return focus ? colors.primary['500'] : '#272727';
    } else {
      return focus ? colors.primary['500'] : '#D8D8D8';
    }
  };
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({focused}): React.ReactNode => {
            return (
              <Box
                width={orientation === 'LANDSCAPE' ? 20 : 'auto'}
                alignItems={'center'}>
                ...
                <Text fontFamily={'Cairo'} color={tabColorMode(focused)}>
                  الرئيسية
                </Text>
              </Box>
            );
